...
class Uddoktapay extends NonmerchantGateway
{
    private $meta;

    public function __construct()
    {
        Loader::load(dirname(__FILE__) . DS . 'lib' . DS . 'UddoktaPayAPI.php');

        $this->loadConfig(dirname(__FILE__) . DS . 'config.json');

        Loader::loadComponents($this, ['Input']);

        Language::loadLang('uddoktapay', null, dirname(__FILE__) . DS . 'language' . DS);
    }
    ...
    public function getSettings(array $meta = null)
    {
        ...
        $this->view->setDefaultView(
            'components' . DS . 'gateways' . DS . 'nonmerchant' . DS . 'uddoktapay' . DS
        );
    ...
    {
        return new UddoktaPayAPI($this->meta['api_key'], $this->meta['api_url']);
    }
